            ...
            <div class="box box-default">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            {!! Field::select('type',
                                ['moto' => 'Moto', 'coche' => 'Coche', '3' => '3.5 a 4.5 Ton', '4' => '5 a 9 Ton', '5' => 'Mas de 10 Ton'], null, ['empty' => 'Seleccione el tipo'])
                            !!}
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            {!! Field::select('key',
                                ['si' => 'Si', 'no' => 'No'], null, ['empty' => '¿Tenía llave?'])
                            !!}
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            {!! Field::select('driver',
                                ...
                                'Rafael' => 'Rafael', 'Deberín' => 'Deberín'], null, ['empty' => 'Seleccione al operador'])
                            !!}
                        </div>
                        <div class="col-md-4">
                            {!! Field::select('unit', $units, null, ['empty' => 'Seleccione la unidad']) !!}
                        </div>
                    </div>
